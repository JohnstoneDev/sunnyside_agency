...
function ImageSection() {
  return (
    <div className='flex w-full items-center justify-between'>
      <img src={cone} alt=""   className='h-96 w-full'/>
      <img src={bottles} alt=""className='h-96 w-full'/>
      <img src={orange} alt="" className='h-96 w-full'/>
      <img src={cubes} alt=""  className='h-96 w-full'/>
    </div>
  )
}
...
export function Footer() {
  return (
    <div>
    <ImageSection />
     <footer className="bg-grayish-blue p-12 text-center flex flex-col gap-6 items-center justify-center">
